...
class _MyCardState extends State<MyCard> {
  ...
  Future<void> _getPolyline(LatLng? origin, LatLng? destination) async {
    if (origin != null && destination != null) {
      ...
      PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
        'AIzaSyC-CQTJaorhqabyY6ajWq-j0y5WIqKdWeQ',
      ...
      if (result.points.isNotEmpty) {
        ...
        List<LatLng> decodedPolyline = _decodePolyline(polylineCoordinates);
        setState(() {
          polylines.add(Polyline(
            polylineId:
                PolylineId('polyline_id'), // Unique identifier for the polyline
            width: 5,
            color: Colors.blue,
  ...
  List<LatLng> _decodePolyline(List<PointLatLng> polylineCoordinates) {
                    ...
                    setState(() {
                      ...
                      if (!hasConfirmed) {
                        ...
                        if (providerLocation != null &&
                          ...
                          // Call method to get polyline
                          _getPolyline(providerLocation, customerLocation);
                        }
                      } else {
