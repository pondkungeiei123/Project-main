...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 28, 2024 at 11:53 AM
...
(1, 'sukanya', 'chinkhum', 'admin@gmail.com', '$2y$10$y1fH.k7PSOE7Do4Askt3deCVEP9ESTCUeaviTsVMfl6oYloBrWYtm'),
...
(3, 'เกียรติยศ', 'เกรียงไกรวรรณ', '0878027981', 'kaittiyos@gmail.com', '$2y$10$tsvphOSbKY9FWEdKU5CO1uPX9cfe.6HYIU1CD7OE7Ky4FFnGDedJq', '14199019461', '6606edd71f1c6_cer.jpg', 'เดอะ เบส ไฮท์ มิตรภาพ - ขอนแก่น', 16.43517318517938, 102.82650925219059),
(10, 'สุกัญญา', 'ชินคำ', '0639781398', 'barber@gmail.com', '$2y$10$y1fH.k7PSOE7Do4Askt3deCVEP9ESTCUeaviTsVMfl6oYloBrWYtm', '15451', '66098df2e11ca_cer.jpg', 'ขอนแก่น', 16.559582523467167, 102.76636306196451);
...
--
ALTER TABLE `booking`
  MODIFY `bk_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=142;
...
--
ALTER TABLE `hairstlye`
  MODIFY `hair_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `workschedule`
  MODIFY `ws_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
